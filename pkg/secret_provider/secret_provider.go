...
// Note: providerType which can be VPC, Bluemix, Softlayer is only used when we need to read storage-secret-store, this is kept to support backward compatibility.
